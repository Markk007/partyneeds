...
@keyframes fadeout {
  ...
  to {bottom: 0; opacity: 0;}
    ...
    <body class="cnt-home" style="background-image: url('img/confetti2.png')">
	
	<div id="snackbar">Updated!</div>
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input onclick="myFunction()" type="submit" name="submit" value="Update shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
